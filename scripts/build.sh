...
java -jar $CURRENT_PATH/tools/yuicompressor-2.3.6.jar $BUILD_PATH/inputex.js -o $BUILD_PATH/inputex-temp-min.js --charset utf8

# Minify CSS using yui compressor
java -jar $CURRENT_PATH/tools/yuicompressor-2.3.6.jar $CURRENT_PATH/../css/inputEx.css -o $BUILD_PATH/inputex-temp-min.css --charset utf8
